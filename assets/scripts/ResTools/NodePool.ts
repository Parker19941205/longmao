...
export class NodePool {
     ...
     * @param url
     */
    public init(node: cc.Node, finishCallback: NodePoolCallback)
    public init(prefab: cc.Prefab, finishCallback: NodePoolCallback)
    ...
    public init() {
        ...
        if (urlOrPrefab instanceof cc.Prefab) {
            ...
            return;
        } else if (urlOrPrefab instanceof cc.Node) {
            this._node = urlOrPrefab;
            this._isReady = true;
            if (finishCallback) {
                finishCallback(null, this);
            }
